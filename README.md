...
Мини-фреймворк для автотестирования, демонстрирующий базовый стек QA-инженера:

- **API-тесты** — на публичном демо-API [Swagger Petstore](https://petstore.swagger.io/v2)
- **UI-тесты** — на публичной демо-странице [TodoMVC (Playwright)](https://demo.playwright.dev/todomvc/) через `playwright`
